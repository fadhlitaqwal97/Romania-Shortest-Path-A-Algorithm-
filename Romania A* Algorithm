...
# heuristik = jarak dari kota n ke bucharest
def getHeuristics():
    heuristics = {}
    f = open("/content/drive/MyDrive/Colab Notebooks/heuristics.txt")
...
# titik koordinat setiap kota pada gambar
def getCity():
    city = {}
    citiesCode = {}
    f = open("/content/drive/MyDrive/Colab Notebooks/cities.txt")
    j = 1
    for i in f.readlines():
...
# jarak antar kota terdekat
def createGraph():
    graph = {}
    file = open("/content/drive/MyDrive/Colab Notebooks/citiesGraph.txt")
